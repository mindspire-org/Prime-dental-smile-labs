...
function Page() {
  ...
  useEffect(() => {
    fetch("/api/admin/pages/technology-3d-printing")
      ...
      <section className="bg-white py-20">
        <div className="max-w-5xl mx-auto px-5 lg:px-8">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Link to="/services/$slug" params={{ slug: "splints-guards" }} className="btn-teal">Splints & Guards <ArrowRight size={16} /></Link>
