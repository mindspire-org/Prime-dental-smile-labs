...
import { Cpu, Printer, Box, ScanLine, Flame, Sparkles, Hammer, Wind, ArrowRight } from "lucide-react";
...
export const Route = createFileRoute("/_marketing/technology")({
  head: () => ({
    ...
    links: [
      { rel: "canonical", href: "https://primesmilelab.com/technology" },
    ],
  }),
  component: TechPage,
});
...
const TECH = [
  { icon: Cpu, name: "ALFAMILL 5-Axis / Yena D30", brand: "CAD/CAM Milling", tags:["Zirconia","PMMA","Wax"], desc:"5-axis simultaneous milling for crowns, bridges and frameworks." },
  { icon: Printer, name: "VENEA VDexk1 eco", brand: "SLM Metal Printing", tags:["Co-Cr","Frameworks"], desc:"Selective laser melting for cobalt-chrome partial denture frameworks." },
  { icon: Box, name: "Asiga MAX UV", brand: "DLP 3D Printing", tags:["Models","Splints","Guides"], desc:"High-resolution DLP printing for splints, models and surgical guides." },
  { icon: ScanLine, name: "Dental Wings 7 Series", brand: "Scanning & Design", tags:["Scan","CAD"], desc:"Lab-grade desktop scanner with full CAD design suite." },
  { icon: Flame, name: "Ivoclar Programat / SpeedFire", brand: "Sintering & Firing", tags:["Ceramic","Sintering"], desc:"Validated sintering & firing protocols for zirconia and lithium disilicate." },
  { icon: Sparkles, name: "Renfert / KaVo", brand: "Finishing & Polishing", tags:["Surface"], desc:"Industry-standard finishing instruments for surface excellence." },
  { icon: Hammer, name: "Bio-Art / Deflex", brand: "Model Workflow", tags:["Articulator"], desc:"Articulators and model systems for accurate occlusal references." },
  { icon: Wind, name: "EKOSAN / Stanley AIR COM", brand: "Air Infrastructure", tags:["Clean Air"], desc:"Clean dry air systems for stable production environments." },
];
    ...
    <div>
      ...
      <section className="bg-white py-16 overflow-hidden">
        ...
        <div className="flex marquee-track gap-3 w-max">
          {[...["ALFAMILL","VENEA","Asiga","Dental Wings","Ivoclar","CEREC","Renfert","KaVo","ISO 9001","ISO 13485","CE Certified"], ...["ALFAMILL","VENEA","Asiga","Dental Wings","Ivoclar","CEREC","Renfert","KaVo","ISO 9001","ISO 13485","CE Certified"]].map((b, i) => (
