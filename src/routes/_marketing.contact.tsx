...
export const Route = createFileRoute("/_marketing/contact")({
  head: () => ({
    ...
    scripts: [
      { type: "application/ld+json", children: JSON.stringify({ "@context": "https://schema.org", "@type": "LocalBusiness", "name": "Prime Smile Dental Laboratory", "description": "Advanced digital dental laboratory serving UK and Cyprus dentists.", "url": "https://primesmiles.eu", "telephone": "+44 20 1234 5678", "email": "support@primesmiles.eu", "address": { "@type": "PostalAddress", "addressCountry": "GB" }, "openingHours": "Mo-Fr 09:00-17:00", "priceRange": "££", "currenciesAccepted": "GBP" }) },
    ],
  }),
